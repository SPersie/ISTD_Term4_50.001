package PS3PartAHW.Q2TestTotalPay;
import java.util.*;
...
public class Employee {
    ...
    public Employee(String nm, String no) throws RuntimeException {
        ...
        if (nm == null || nm.equals("")) {
            throw new RuntimeException("Illegal inputs for Employee name");
        } else if(no ==null || no.equals("")) {
            throw new RuntimeException("Illegal inputs for Employee number");
        }
        else {
            this.name =nm;
            this.number =no;
